package com.example.tfd.ui.kva25;
...
public class Kva25Fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        double ratedKva = parseDouble(getText(binding.specRatedKva), 25.0);   // ✅ default 25 KVA
