package com.example.tfd.ui.kva10;
...
public class Kva10Fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        // Specs (with fallback values)
        double ratedKva = parseDouble(getText(binding.specRatedKva), 10.0);
