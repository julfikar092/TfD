package com.example.tfd.ui.kva37;
...
public class Kva37Fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        double ratedKva = parseDouble(getText(binding.specRatedKva), 37.5);   // ✅ default 37.5 KVA
